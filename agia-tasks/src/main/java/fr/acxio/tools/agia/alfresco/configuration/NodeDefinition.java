...
/**
 * Alfresco local representation of nodes.</br>
 * The NodeDefinition describes how a node (folder or document) will be created
 * in Alfresco:</br>
 * <ul>
...
public interface NodeDefinition {
	...
	/**
	 * <p>Returns the type of the Node as the String representation of a QName.
	 * </p>
	 * 
	...
	/**
	 * <p>Returns the version operation identifier.</p>
	 * <p>It can be: RAISEERROR, VERSION, REPLACE or UPDATE.</p>
	 * 
	...
	/**
	 * <p>Returns the ID designating the current Node that can be used into
	 * associations.</p>
	 * 
	...
	/**
	 * <p>Returns the definitions of properties</p>
	 * 
	...
	/**
	 * <p>Adds a definition of a property to the current Node definition.</p>
	 * 
	 * @param sPropertyDefinition the definition of a property
	 */
	void addPropertyDefinition(PropertyDefinition sPropertyDefinition);
	
	/**
	 * <p>Returns the definitions of aspects</p>
	 * 
	...
	/**
	 * <p>Adds a definition of an aspect to the current Node definition.</p>
	 * 
	 * @param sAspectDefinition the definition of an aspect
	 */
	void addAspectDefinition(AspectDefinition sAspectDefinition);
	
	/**
	 * <p>Returns the definitions of associations</p>
	 * 
	...
	/**
	 * <p>Adds a definition of an association to the current Node definition.
	 * </p>
	 * 
	 * @param sAssociationDefinition the definition of an association
	 */
