...
public abstract class NodeDefinitionFactoryBean<T> implements FactoryBean<T>, InitializingBean {
	...
	public void setPropertiesDefinitions(
			List<PropertyDefinition> sPropertiesDefinitions) {
	...
	public void setAssociationsDefinitions(
			List<AssociationDefinition> sAssociationsDefinitions) {
