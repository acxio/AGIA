...
/**
 * <p>Factory for a single resource at a time.</p>
 * 
 * @author pcollardez
 *
 */
public interface ResourceFactory {
	...
	/**
	 * <p>Returns a resource according to its internal implementation.</p>
	 * 
	...
	/**
	 * <p>Returns a resource according to the given parameters.</p>
	 * <p>If a specific implementation does not use the parameters, it should
	 * return the same resource it would return without any parameters.</p>
	 * 
	 * @param sParameters the parameters to use to create the resource
	 * @return a single resource
	 * @throws ResourceCreationException if the resource cannot be created
	 */
