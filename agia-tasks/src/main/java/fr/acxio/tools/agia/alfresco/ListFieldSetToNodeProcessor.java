 ...
 * <p>The input list of FieldSets represents a coherent set of documents.
 * Each document may be related to an other in this set according to
 * associations described into a
 * {@link fr.acxio.tools.agia.alfresco.configuration.NodeFactory NodeFactory}
 * .</p>
 * <p>The NodeFactory is used for each FieldSet to build a NodeList. The
 * conditions defined in the NodeFactory may help when creating these nodes.</p>
 * <p>Resulting NodeLists are merged to remove duplicated nodes, like parents
 * folders.</p>
 * <p>The returned NodeList should not contain any duplicates and parent/child
