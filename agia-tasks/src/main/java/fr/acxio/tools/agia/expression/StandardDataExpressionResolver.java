...
/**
 * <p>Standard expression resolver.</p>
 * <p>This resolver uses the prefix "@{" and the suffix "}" by default.</p>
 * <p>It caches the expressions to prevent systematic recompilation of them.</p>
 * <p>If the result of the evaluation cannot be cast to the given class, an
...
public class StandardDataExpressionResolver implements DataExpressionResolver {
	...
	/**
	 * <p>Specify the EL parser to use for expression parsing.</p>
	 * <p>Default is a
	 * {@link org.springframework.expression.spel.standard.SpelExpressionParser SpelExpressionParser},
	 * compatible with standard Unified EL style expression syntax.</p>
	 */
	...
	@Override
	public <T> T evaluate(String sExpression,
			EvaluationContext sEvalContext, Class<T> sTargetType) {
